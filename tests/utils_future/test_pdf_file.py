    ...
    def test_si(self):
        ...
        self.assertEqual(
            blocks[0],
            {
                ...
                "text": "ප ොලිස් මොධ්\u200dය ප ොට්ඨොසය පෙත ෙොර්තො වූ ෙැදගත් පතොරතුරු 01. මනුෂ්\u200dය ඝොතනයක් - තිස්සමහොරොම ප ොලිස් ෙසම.",  # noqa: E501
        ...
        self.assertEqual(
            blocks[7],
            {
                ...
                "text": "03. දය අනතුරකින් තරුණයින් තිපදපනකු පේරො ගැනීම - ප ොලිස් ජීවිතොරක්ෂ්\u200d ඒ ය ගල්කකිස්ස.",  # noqa: E501
                "fonts": ["IskoolaPota-Bold"],
